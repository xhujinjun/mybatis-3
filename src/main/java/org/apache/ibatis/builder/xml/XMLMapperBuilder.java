...
public class XMLMapperBuilder extends BaseBuilder {
    ...
    public void parse() {
        //该XMLMapper文件是否已经被加载过了
        if (!configuration.isResourceLoaded(resource)) {
            //解析XMLMapper文件，并把对应的信息放入Configution中
    ...
    private void configurationElement(XNode context) {
        try {
            ...
            //A mapped select|insert|update|delete statement.
    ...
    private ResultMapping buildResultMappingFromContext(XNode context, Class<?> resultType,
        ...
        return builderAssistant
                .buildResultMapping(resultType, property, column, javaTypeClass, jdbcTypeEnum, nestedSelect,
                        nestedResultMap, notNullColumn, columnPrefix, typeHandlerClass, flags, resulSet, foreignColumn,
                        lazy);
    }
