...
public class XMLConfigBuilder extends BaseBuilder {
    ...
    private void parseConfiguration(XNode root) {
        try {
            ...
            //对应Configtion的variables
            propertiesElement(root.evalNode("properties"));
            // 对应Configtion的typeAliasRegistry
            typeAliasesElement(root.evalNode("typeAliases"));
            //对应Configuration的interceptorChain
            ...
            //mappedStatements 或者(和) MapperRegistry
        ...
        if (parent != null) {
            for (XNode child : parent.getChildren()) {
                ...
                if ("package".equals(child.getName())) {
                    ...
                    //如果子节点的属性是resource，则使用XMLMapperBuilder来解析resource
                    ...
                    //如果子节点的属性是url，则使用XMLMapperBuilder来解析url
                    ...
                    //如果子节点的属性是class，则使用mapperRegistry注入该接口
                    else if (resource == null && url == null && mapperClass != null) {
                        Class<?> mapperInterface = Resources.classForName(mapperClass);
                        configuration.addMapper(mapperInterface);
                    }
                    //如果子节点的属性是其它情况就抛出BuilderException
                    else {
                        throw new BuilderException(
